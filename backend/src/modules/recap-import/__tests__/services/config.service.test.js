...
describe("recap import config", () => {
  ...
  it("rejects queue concurrency greater than 1 for MVP", () => {
    expect(() =>
      loadRecapImportConfig({ ...validEnv, RECAP_IMPORT_QUEUE_CONCURRENCY: "3" })
